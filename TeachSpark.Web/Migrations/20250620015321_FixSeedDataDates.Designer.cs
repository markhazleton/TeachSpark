...
namespace TeachSpark.Web.Migrations
{
    ...
    [Migration("20250620015321_FixSeedDataDates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeachSpark.Web.Models.ApiKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TeachSpark.Web.Models.ApiUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TeachSpark.Web.Models.BloomLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TeachSpark.Web.Models.CommonCoreStandard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TeachSpark.Web.Models.Worksheet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TeachSpark.Web.Models.WorksheetExport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TeachSpark.Web.Models.WorksheetTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TeachSpark.Web.Models.ApiUsage", b =>
                {
                    b.HasOne("TeachSpark.Web.Models.ApiKey", "ApiKey")
                        .WithMany("ApiUsages")
            ...
            modelBuilder.Entity("TeachSpark.Web.Models.Worksheet", b =>
                {
                    b.HasOne("TeachSpark.Web.Models.BloomLevel", "BloomLevel")
                        .WithMany("Worksheets")
                        .HasForeignKey("BloomLevelId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TeachSpark.Web.Models.CommonCoreStandard", "CommonCoreStandard")
                        .WithMany("Worksheets")
                        .HasForeignKey("CommonCoreStandardId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TeachSpark.Web.Models.WorksheetTemplate", "Template")
                        .WithMany("Worksheets")
            ...
            modelBuilder.Entity("TeachSpark.Web.Models.WorksheetExport", b =>
                {
                    b.HasOne("TeachSpark.Web.Models.Worksheet", "Worksheet")
                        .WithMany("Exports")
