...
7. Write the completed constitution back to `/.documentation/memory/constitution.md` (overwrite).
...
Do not create a new template; always operate on the existing `/.documentation/memory/constitution.md` file.
