...
**Tests**: The examples below include test tasks. Tests are REQUIRED for any new or changed behavior under the constitution. Omit them only for changes that are strictly documentation, content, or non-behavioral configuration updates.
...
- [ ] TXXX [P] Additional unit tests needed for remaining coverage in tests/unit/
- [ ] TXXX Security hardening and authorization verification
